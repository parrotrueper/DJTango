...
from djtango.qt_compat import QDialog, QColor, QModelIndex, Qt, QtWidgets
...
class PreferencesMixin:
    ...
    def _addTangoType(self):
        ...
        self.prefContent.listWidgetTangoType.setCurrentRow(lastRow, QtWidgets.QItemSelectionModel.ClearAndSelect)
