...
from djtango.qt_compat import QCursor, QMediaContent, QMediaPlayer, QApplication, QColor, Qt, QtCore, QtGui, QModelIndex
...
class AudioPlaybackMixin:
    ...
    def _load_new_media(self):
        if not os.path.isfile(self.curTango.path):
            ...
            return False
        self.mediaSource = QMediaContent(QtCore.QUrl.fromLocalFile(QtCore.QFileInfo(self.curTango.path).absoluteFilePath()))
