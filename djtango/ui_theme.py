...
def track_preview_style(background_color, font_color):
    return (
        'background-color: %s; color: %s; border: 1px solid #5a5a5a; padding: 10px;' % (
            qss_color(background_color),
            qss_color(font_color),
        )
    )
...
def button_style(background_color, font_color):
    return (
        'background-color: %s; color: %s; border: 1px solid #5a5a5a; padding: 6px 12px;' % (
            qss_color(background_color),
            qss_color(font_color),
        )
    )
...
def side_display_frame_style(background_color):
    return (
        'QFrame{ background-color: %s; border: 0px; margin-right: 0px; margin-bottom: 0px; '
...
def side_display_label_style(font_color):
    return (
        'font-weight: bold; color: %s; font-size: 100px; font-family: "sans"; '
        'background-color: transparent;' % qss_color(font_color)
    )
