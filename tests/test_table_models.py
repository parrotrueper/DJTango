...
from djtango.qt_compat import QDataStream, QIODevice, QModelIndex, Qt
from PySide6.QtCore import QByteArray
from djtango.tracksong import TrackSong
from djtango.milonga_manager import MilongaManagerMixin
from djtango.tableModels import library, milongaSource, sourceFilterProxyModel, normalize_type_key
...
def test_milonga_dest_drop_converts_string_genre_to_type_id():
    ...
    from djtango.tableModels import milongaDest
