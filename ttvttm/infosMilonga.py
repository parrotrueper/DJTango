...
# Form implementation generated from reading ui file 'UI_infosMilonga.ui'
#
...
class Ui_infos:
    def setupUi(self, infos):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("img/logo-ttvttm.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
