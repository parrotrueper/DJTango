...
"}")
    ...
    def retranslateUi(self, preferences):
        ...
        self.addTypeButton.setToolTip(_translate("preferences", "Add a new track type."))
        ...
        self.checkBoxWriteTags.setText(_translate("preferences", "Always write Tags when updating a track"))
        self.checkBoxNormalize.setToolTip(_translate("preferences", '<html><head/><body><p>If you check this, each time you make a change to one of your files, the file name and path will be updated to respect the following rules:</p><p>YYYY<span style=" font-weight:600;">-</span>Name of track<span style=" font-weight:600;">-</span>Artist<span style=" font-weight:600;">-</span>Album<span style=" font-weight:600;">-</span>Type.ext</p><p><span style=" color:#ff0004;">Be aware that this will completely change the organisation of your directory!</span></p></body></html>'))
