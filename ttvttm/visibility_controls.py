...
class VisibilityControlsMixin:
    def _handelHideSource(self):
        if self._dialog.milongaSource.isVisible():
            ...
            self._dialog.pushButtonHideSource.setIcon(QIcon("./ttvttm/img/hide-right.png"))
            ...
            self._dialog.pushButtonHideSource.setIcon(QIcon("./ttvttm/img/hide-left.png"))
    ...
    def _handelHideDest(self):
        if self._dialog.milongaDest.isVisible():
            ...
            self._dialog.pushButtonHideDest.setIcon(QIcon("./ttvttm/img/hide-left.png"))
            ...
            self._dialog.pushButtonHideDest.setIcon(QIcon("./ttvttm/img/hide-right.png"))
