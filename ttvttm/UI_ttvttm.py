...
# Form implementation generated from reading ui file './gui/UI_ttvttm.ui'
#
...
class Ui_AudioPlayerDialog:
    def setupUi(self, AudioPlayerDialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/img/ttvttm.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"{\n"
"    image: url(./ttvttm/img/arrow-bottom.png);\n"
"    width: 16px;\n"
"    height: 16px;\n"
"    border-style: none;\n"
"}")
...
"")
        ...
        self.actionTrackAppearance = QtGui.QAction(AudioPlayerDialog)
        ...
        self.actionLibraryContents = QtGui.QAction(AudioPlayerDialog)
    ...
    def retranslateUi(self, AudioPlayerDialog):
        ...
        AudioPlayerDialog.setWindowTitle(_translate("AudioPlayerDialog", "TTVTTM"))
